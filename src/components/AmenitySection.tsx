      ...
      <div className="grid gap-8 sm:grid-cols-2">
        {amenities.map((group) => (
          <div key={group.category}>
            <div className="mb-4 flex items-center gap-2 text-sand-400">
              {categoryIcons[group.category] || categoryIcons.Essentials}
            ...
            <ul className="space-y-3">
              {group.items.map((item) => (
                ...
                >
                  <svg
                    className="h-4 w-4 flex-shrink-0 text-sand-400/60"
                    fill="none"
                    viewBox="0 0 24 24"
                    strokeWidth={2}
                    stroke="currentColor"
